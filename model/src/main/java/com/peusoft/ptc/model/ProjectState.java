...
@NamedQueries({
    ...
    @NamedQuery(name = "ProjectState.findById", query = "SELECT p FROM ProjectState p WHERE p.id = :id"),
...
public class ProjectState implements Serializable {
    ...
    public ProjectState(Integer id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public String toString() {
        return "com.peusoft.ptc.model.ProjectState[ id=" + id + " ]";
    }
